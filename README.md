...
- [A check](https://github.com/kokke/tiny-lint-c/blob/master/src/check_return_count_in_functions.c) for [too many `return`-statements in a function](https://wiki.c2.com/?SingleFunctionExitPoint) (configurable limits on 'too many'), e.g. warning if a function has more than 3 places it can `return` from.
